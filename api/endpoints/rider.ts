...
export const riderApi = {
  ...
  getActiveRide: async () => {
    return await apiService.get("/rider/active-ride");
  },
  ...
  walletTopUp: async (reference: string, amount: number, status: string) => {
    return await apiService.post("rider/wallet/topup", {
      reference,
      amount,
      status,
    });
